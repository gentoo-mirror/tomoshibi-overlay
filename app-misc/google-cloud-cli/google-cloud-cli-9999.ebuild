...
#
# From supertux88 overlay
#

EAPI=8

PYTHON_COMPAT=( python3_{10..13} python3_13t python3_14 )
...
if [[ ${PV} = *9999* ]] ; then
	SRC_URI="https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-cli-linux-x86_64.tar.gz"
else
